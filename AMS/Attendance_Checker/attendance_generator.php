...
$insertSql = "INSERT INTO schedule (user_id, subject_code, subject_units, schedule_time_start, schedule_time_end, room, schedule_day, request, section, alert) 
              SELECT 
              ...
              FROM request
              WHERE schedule_date = '$currentDate' AND schedule_generate = 'TRUE' AND status = 'approved'";
