...
<body>
  ...
  <div class="container">
    ...
    <form id="scheduleForm" method="post" action="save_schedule.php?id=<?php echo $user_id; ?>">
  ...
  <script>
    ...
    function addRow() {
      ...
      cell10.innerHTML = "<textarea name='reason[]' ></textarea>"; // Placeholder for status (to be filled dynamically)
      cell11.innerHTML = ""; // Placeholder for academic year (to be filled dynamically)
      cell12.innerHTML = "<button class='delete-button' onclick='deleteRow(this.parentNode.parentNode)'>Delete</button>";
